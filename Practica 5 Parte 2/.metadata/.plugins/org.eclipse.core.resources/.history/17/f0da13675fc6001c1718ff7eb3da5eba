...
class PersoonalTest {
	...
	public void setUp() {
		...
		this.sistema.listaGuiaTelefonica.agregarTelefono(this.sistema, "2214444554");
		this.sistema.listaGuiaTelefonica.agregarTelefono(this.sistema, "2214444555");
		this.sistema.listaGuiaTelefonica.agregarTelefono(this.sistema, "2214444556");
		this.sistema.listaGuiaTelefonica.agregarTelefono(this.sistema, "2214444557");
	...
	void testAgregarUsuario() {
		...
		this.sistema.listaGuiaTelefonica.agregarTelefono(this.sistema, "2214444558"); 
